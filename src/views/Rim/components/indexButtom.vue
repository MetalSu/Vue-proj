      ...
      <div class="uni-tabbar" style="background-color: rgb(255, 255, 255);">
        ...
        <div class="uni-tabbar__item">
          <div class="uni-tabbar__bd">
            ...
            <div @click="goToIndex" class="uni-tabbar__label" style="color: rgb(187, 187, 187); font-size: 10px;">
              演出
              <!---->
            </div>
          </div>
        ...
        <div class="uni-tabbar__item">
          <div class="uni-tabbar__bd">
            ...
            <div @click="goToRim" class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 10px;">
              周边
              <!---->
            </div>
          </div>
        ...
        <div class="uni-tabbar__item">
          <div class="uni-tabbar__bd">
            ...
            <div @click="goToRaise" class="uni-tabbar__label" style="color: rgb(187, 187, 187); font-size: 10px;">
              众筹
              <!---->
            </div>
          </div>
        ...
        <div class="uni-tabbar__item">
          <div class="uni-tabbar__bd">
            ...
            <div @click="goToMy" class="uni-tabbar__label" style="color: rgb(187, 187, 187); font-size: 10px;">
              我的
              <!---->
            </div>
          </div>
